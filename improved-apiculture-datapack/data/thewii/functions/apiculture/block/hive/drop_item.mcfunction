...
execute if entity @s[tag=twia.hive.oak] run data modify storage thewii:vp_library/temp item set from storage thewii:apiculture/data item.oak_beehive
execute if entity @s[tag=twia.hive.spruce] run data modify storage thewii:vp_library/temp item set from storage thewii:apiculture/data item.spruce_beehive
execute if entity @s[tag=twia.hive.birch] run data modify storage thewii:vp_library/temp item set from storage thewii:apiculture/data item.birch_beehive
execute if entity @s[tag=twia.hive.jungle] run data modify storage thewii:vp_library/temp item set from storage thewii:apiculture/data item.jungle_beehive
