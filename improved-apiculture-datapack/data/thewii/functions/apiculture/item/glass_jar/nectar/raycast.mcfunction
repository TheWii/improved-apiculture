# Raycast
execute as @e[type=minecraft:bee,dx=0,tag=!global.ignore] positioned ~-0.9 ~-0.9 ~-0.9 if entity @s[dx=0] run function thewii:apiculture/item/glass_jar/nectar/found_entity
