...
execute if data storage thewii:vp_library/temp item{id:"minecraft:warped_fungus_on_a_stick",tag:{ctc:{from:"thewii:apiculture",id:"beekeeping_hat"}}} run function thewii:apiculture/entity/item/beekeeping_hat